...
export class Similarity {
  ...
  activate(params) {
    ...
    this.api.get_league_similarities(this.league_id, member_id).then((similarities) => {
    ...
    const breadcrumbs = [
      ...
      new Breadcrumb("Voting Comparison", "league-similarity", {league_id: this.league_id, member_id: member_id}),
    ];
